...
function send_password_reset($get_name, $get_natID, $get_email, $token) {
    ...
    $email_body_template = "
        ...
        <br/>
        <a href='https://eastremboportal.azurewebsites.net/PAGES/password-change.php?token=$token&email=$get_email'>Click here to reset your password</a>
        <br/>
...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($seeker_result) > 0) {
        ...
        $update_token = mysqli_query($conn, "UPDATE seeker_account SET verify_token='$token' WHERE Email_add='$get_email' LIMIT 1");
    ...
    // CITIZEN CHECK EMAIL IF EXISTING
