        ...
        if (mysqli_num_rows($check_token) > 0) {
            ...
            if ($new_password == $confirmpass) {
                ...
                if ($update_password) {
                    ...
                    window.location.href = 'pass-change.php?token=$token&email=$email';
                    </script>";
                    exit(0);
                }
            ...
            if (mysqli_num_rows($admin_check_token) > 0) {
                ...
                $admin_correct_pass = password_verify($cur_password, $admin_db_pass);
               ...
               if ($admin_correct_pass == 1) {
                ...
                if ($new_password == $confirmpass) {
                    ...
                    window.location.href = 'pass-change.php?token=$token&email=$email';</script>";
                    exit(0);
               }
...
<body >
    <form class="form" action="" method="post" name="signup-form">
        ...
        <div class="inputForm">
            ...
            <input type="password" name="cur_password" id="password" class="input" placeholder="Enter Current Password" required>
